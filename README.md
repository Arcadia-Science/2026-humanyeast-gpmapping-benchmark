...
[A benchmark for the next generation of genotype-phenotype mapping](https://doi.org/10.57844/arcadia-27pw-kx6m0)
...
Please download data from [Zenodo](https://doi.org/10.5281/zenodo.19860006). To run the analysis using a subset of the yeast data, please place the following files into a folder titled `input_data/`:
...
| `yeast_true_avg_distance_1510.feather` | Average distances between simulated true and top estimates for all methods and traits in human |
...
- Data/code for plotting figures 9 (ROC plots for human) and 11 (variant effect prediction by minor allele frequency) from our [publication](https://doi.org/10.57844/arcadia-27pw-kx6m) are not included for human data security reasons.
